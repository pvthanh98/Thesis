      ...
      <Container>
        <Grid container>
          <Grid item style={{ minHeight: "500px", padding: "8px" }}>
            ...
            <Badge color="primary">22/08/2020</Badge>{" "}
            <Badge color="danger">System Admin</Badge>
            <Typography
              variant="body1"
              style={{ textAlign: "justify", marginTop: "8px" }}
            >
              Hệ thống cứu hộ oto ThanhPhan rescuing được thành lập vào năm
              xxxx, là hệ thống tiên phong trong việc kết nối các cửa hàng cứu
              hộ và các xe oto gặp sự cố trên đường Contrary to popular belief,
