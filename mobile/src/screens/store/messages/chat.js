...
import ChatItem from '../../../components/admin_side/message/Item';
...
export default ({route, navigation}) => {
    ...
    useEffect(()=>{  
      ...
      navigation.setOptions({title:customer_name})
      return () => {
    ...
    if(!messages.info.customer.name) return  <Load />
    return (
